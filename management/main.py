...
from management.settings import BaseAppSettings, DevAppSettings, TestAppSettings
...
settings = (
    settings_[current_environment]() if current_environment else BaseAppSettings()
)
